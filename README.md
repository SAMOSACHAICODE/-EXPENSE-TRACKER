# -EXPENSE-TRACKER
This Python CLI script tracks expenses using a local CSV file. Users can add, view, delete, and filter transactions via a menu. It features automatic ID generation, date defaults, category filtering, and monthly summaries, utilizing standard libraries for lightweight, persistent data management..
This Python CLI script tracks expenses using a local CSV file. Users can add, view, delete , and filter transcations via a menu. It features automatic ID generation , date defaults, category filtering, and monthly summaries, utilising standard librarues for lightweight ,
...
Select 3.
Type in id: 1.Result:You should see"delete id 1".
Test Delete (Option 3):
Select 3.
Type in id: 1.Result:You should see"delete id 1".
